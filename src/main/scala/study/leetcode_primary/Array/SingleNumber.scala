...
object SingleNumber {
  ...
  /**
    * https://blog.csdn.net/smile_watermelon/article/details/47733979
    *
    * 题目描述
    ...
    * *
    * 解题思路
    * 这个题与有一个数组data[n-1]存储了1~n中的n-1个数，问data中缺少的数字是多少【每日一题】实质上是一样的。此处仅把其中最优的位操作法重复举一下，更详细的请参考上述博文。
    * *
